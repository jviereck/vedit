(function (window) {
    ...
    Jvent.prototype.offListener = function (listener) {
      var collection = this._collection[event] || {};
      for (var name in collection) {
        if (collection.hasOwnProperty(name)) {
          for (var j = collection[name].length; j >= 0; j++) {
            if (collection[name][j] === listener) {
    ...
    Jvent.prototype.removeEverything = function () {
        for (var name in this._collection) {
